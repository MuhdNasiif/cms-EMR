  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text("Diagnosis",style:GoogleFonts.roboto(fontSize: 14,fontWeight: FontWeight.w500,color: Colors.black))),
        actions: [
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        ...
                        child: Text("Abortion",style: GoogleFonts.roboto(fontSize: 16,fontWeight: FontWeight.w500,color: colorblack),)),
                    ),
                  ),
                );
              },),
                          ...
                          showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                backgroundColor: Colors.transparent,
                                content: Detailcontainer(txt:"Add Diagnosis", txt2: 'Diagnosis Name',ok: 'SUBMIT')
                              );
                            },);
                        },
                        child: Container(
                          ...
                          showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                alignment: Alignment.center,
                                backgroundColor: Colors.transparent,
                                content: Detailcontainer(txt: "Edit Diagnosis", txt2: 'Diagnosis Name',ok: 'SUBMIT')
                              );
                            },);
                        },
                        child: Container(
